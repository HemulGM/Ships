...
type
  TFormShipPoly = class(TForm)
    ...
    procedure ButtonExit1MouseEnter(Sender: TObject);
    procedure ButtonExit1MouseExit(Sender: TObject);
  private
...
procedure TFormShipPoly.WMNCHitTest (var M:TWMNCHitTest);
begin
 inherited;
...
procedure TFormShipPoly.ButtonExit1MouseEnter(Sender: TObject);
begin
 Need:=False;
end;

procedure TFormShipPoly.ButtonExit1MouseExit(Sender: TObject);
begin
 Need:=True;
end;
